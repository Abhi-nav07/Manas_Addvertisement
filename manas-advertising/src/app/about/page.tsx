...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn about Manas Advertising — a premium advertising and branding studio based in Mumbai, India.",
};
            ...
            <div className="md:sticky md:top-32">
              <Reveal>
                ...
                <p className="mt-5 text-neutral-500 leading-relaxed">
                  Manas Advertising started in Mumbai with a small team convinced
